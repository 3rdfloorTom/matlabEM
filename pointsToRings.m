...
%%% i.e., croppingTbl = pointsToRings('catalogueName');
%%%
%%% At maximum, it takes the catalogue name, dz, dphi
%%% i.e., croppingTbl = pointsToRings('catalogueName', zstep, radius, spr)
...
%%%
%%% Author: (TL UCSD 2020)
function [totalCrop] = pointsToRings(catalogueName,dz,radius,spr) 

% Check user inputs
if nargin ~= 4
    error('pointsToRings(): Too many inputs, takes 4 at most')
end
